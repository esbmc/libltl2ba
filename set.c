...
void dot_print_set(int *pos, int *neg,int need_parens) /* prints the content of a set for dot */
{
  int i, j, start = 1;
  int count = 0, cex;
  for(i = 0; i < sym_size; i++)
...
void print_sym_set(int *l, int size) /* prints the content of a symbol set */
{
  int i, j, cex, start = 1;;
  for(i = 0; i < size; i++)
    for(j = 0; j < mod; j++)
