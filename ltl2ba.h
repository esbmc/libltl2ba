...
void spin_print_set(FILE *, const char *const *sym_table, int *, int*, int sym_size);
void dot_print_set(FILE *, const char *const *sym_table, const tl_Cexprtab *cexpr, int *, int*, int sym_size, int);
